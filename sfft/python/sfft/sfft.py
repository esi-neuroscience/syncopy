...
class sfft:
  ...
  # Load libssft from local build folder so we don't have to actuall install it
  this_file = os.path.abspath(__file__)
  lib_name = 'libsfft' + np.distutils.misc_util.get_shared_lib_extension()
  libsfft = cdll.LoadLibrary(this_file.partition("python")[0] + "build" + os.sep + lib_name)
