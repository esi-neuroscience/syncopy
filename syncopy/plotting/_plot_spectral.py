...
# Last modification time: <2020-08-06 14:39:08>
...
def singlepanelplot(self, trials="all", channels="all", tapers="all", toilim=None, foilim=None,
    ...
    if not isTimeFrequency:
        ...
        if fig is None:
            fig, ax = _setup_figure(1, xLabel="Frequency [Hz]", yLabel=dataLbl)
        ...
        fig, ax, cax = _setup_figure(1, xLabel="Time [s]", yLabel="Frequency [Hz]", include_colorbar=True)
