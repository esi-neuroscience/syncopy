...
def singlepanelplot(self, trials="all", channels="all", toilim=None, avg_channels=True,
    ...
    if avg_channels:
        ...
        if nTrials == 0:
            ...
            chanSec = np.arange(self.channel.size)[self.selection.channel]
        ...
        # Average across trials
            ...
            for k, trlno in enumerate(trList):
                idx[timeIdx] = self.selection.time[k]
...
def multipanelplot(self, trials="all", channels="all", toilim=None, avg_channels=False,
    ...
    if avg_trials and not avg_channels:
        ...
        idx[timeIdx] = self.selection.time[0]
        time = self.time[trList[k]][self.selection.time[0]]
    ...
    # Panels correspond to trials
        ...
        for k, trlno in enumerate(trList):
            idx[timeIdx] = self.selection.time[k]
            time = self.time[trList[k]][self.selection.time[k]]
            ax_arr[k].plot(time,
