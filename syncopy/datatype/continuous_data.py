...
# Last modification time: <2020-05-06 18:37:53>
...
class AnalogData(ContinuousData):
    ...
    # asdf = _plot_analog._singleplot # USE THIS!
    ...
    def singleplot(self, trials="all", channels="all", toilim=None, avg_channels=True,
        ...
        if hasattr(fig, "nTrialPanels") or hasattr(fig, "nChanPanels"):
            ...
            act = "multi-panel figure generated by `multiplot`"
    ...
    def multiplot(self, trials="all", channels="all", toilim=None, avg_trials=True,
                  avg_channels=False, title=None, grid=None, fig=None, **kwargs):
        """
        Coming soon...
        ...
        if hasattr(fig, "objCount"):
            if not hasattr(fig, "nTrialPanels") and not hasattr(fig, "nChanPanels"):
                lgl = "overlay-figure generated by `multiplot`"
                act = "figure generated by `singleplot`"
                raise SPYValueError(legal=lgl, varname="fig/singleplot", actual=act)
