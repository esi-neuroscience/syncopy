...
if __name__ == "__main__":
    ...
    # plt.pause(1.0)
    # data.singleplot(trials=[5,9,100], channels=channels, toilim=toilim, fig=plt.gcf())
    # plt.pause(1.0)
    # data.singleplot(trials=trials, channels=channels, toilim=toilim, avg_trials=False)
    # plt.pause(1.0)
    # data.singleplot(trials=[5,9,100], channels=channels, toilim=toilim, fig=plt.gcf(), avg_trials=False)
    # plt.pause(1.0)
    # data.singleplot(trials=[81, 82, 83], channels=channels, toilim=toilim, fig=plt.gcf(), avg_trials=False)
    # plt.pause(1.0)
    # data.singleplot(trials=None, channels=channels)
    # plt.pause(1.0)
    # data.singleplot(trials=np.arange(8), channels=channels, toilim=toilim, avg_trials=False)
    # plt.pause(1.0)
    # data.singleplot(trials=np.arange(100, 120), channels=channels, toilim=toilim, avg_trials=False)
    # plt.pause(1.0)
    # data.singleplot(trials=trials, channels=channels, toilim=toilim, grid=False, title="grid is false")
    # plt.pause(1.0)
    # data.singleplot(trials=trials, channels=channels, toilim=toilim, grid=True, title="grid is true")
